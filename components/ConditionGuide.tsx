...
const CONDITIONS = [
  {
    ...
    details: [
      "Copertina senza difetti",
      "Pagine bianche e integre",
      "Nessun segno di apertura o lettura",
      "Confezione originale se prevista",
    ],
    example: "Fumetto mai aperto, action figure ancora in blister.",
  },
  {
    value: "ottimo",
    label: "Ottimo",
    ...
    details: [
      "Copertina praticamente perfetta",
      "Possibile lieve piega su un angolo",
      "Pagine pulite senza sottolineature",
      "Dorso integro",
    ],
    example: "Fumetto letto una volta con attenzione. Videogioco con custodia originale in perfetto stato.",
  },
  {
    value: "buono",
    label: "Buono",
    ...
    dot: "bg-amber-400",
    description: "Usato normalmente, segni di lettura/utilizzo visibili ma il prodotto è completamente funzionante e piacevole da leggere/usare.",
    details: [
      "Copertina con segni d'uso lievi",
      "Possibili piccole pieghe o abrasioni",
      "Pagine integre, possibile leggera ingiallimento",
      "Nessuno strappo o mancanza",
    ],
    example: "Romanzo letto più volte. Console con qualche graffietto sulla scocca.",
  },
  {
    value: "discreto",
    label: "Discreto",
    ...
    dot: "bg-neutral-400",
    description: "Segni d'uso evidenti ma il prodotto è completo e leggibile/funzionante. Ideale per chi vuole il contenuto a prezzo minimo.",
    details: [
      "Copertina con usura visibile",
      "Possibili pieghe o piccoli strappi riparati",
      "Pagine integre ma con segni di lettura",
      "Eventuali annotazioni a matita",
    ],
    example: "Fumetto vintage con copertina consumata. Libro con ex libris o dedica.",
  },
];
